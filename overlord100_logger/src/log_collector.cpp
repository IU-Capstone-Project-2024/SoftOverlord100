...
//     {
//         log_publisher_ = this->create_publisher<overlord100_logger::LogMessage>("/logs", 10);
//         log_subscription_ = this->create_subscription<rcutils_logging::Log>(
//             "rosout", 10, std::bind(&LogCollectorNode::logCallback, this, std::placeholders::_1));
//     }

// private:
//     void logCallback(const rcutils_logging::Log::SharedPtr log_msg)
//     {
//         overlord100_logger::LogMessage log;
...
//     rclcpp::Publisher<overlord100_logger::LogMessage>::SharedPtr log_publisher_;
//     rclcpp::Subscription<rcutils_logging::Log>::SharedPtr log_subscription_;
// };
