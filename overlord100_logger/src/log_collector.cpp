...
class LogCollectorNode : public rclcpp::Node {
 public:
  LogCollectorNode() : Node("log_collector") {
    log_publisher_ =
        this->create_publisher<overlord100_msgs::msg::LogMessage>("/logs", 10);
    log_subscription_ = this->create_subscription<rcl_interfaces::msg::Log>(
        "/rosout", 10,
        std::bind(&LogCollectorNode::logCallback, this, std::placeholders::_1));
  }
 ...
 private:
  ...
  rclcpp::Publisher<overlord100_msgs::msg::LogMessage>::SharedPtr
      log_publisher_;
