...
public:
    ...
    {
        publisher_ = this->create_publisher<geometry_msgs::msg::Twist>("auto_cmd_vel", 10);
        timer_ = this->create_wall_timer(
            std::chrono::milliseconds(500), std::bind(&AutoVelocityPublisher::publish_velocity, this));
    }
