...
class NavigationController : public rclcpp::Node {
   public:
    NavigationController() : Node("navigation_controller"), current_mode_(0) {
        mode_service_ =
            this->create_service<overlord100_interfaces::srv::ChangeMode>(
                "change_mode",
   ...
   private:
    void changeModeCallback(
        const std::shared_ptr<overlord100_interfaces::srv::ChangeMode::Request>
            request,
        std::shared_ptr<overlord100_interfaces::srv::ChangeMode::Response>
            response) {
    ...
    rclcpp::Service<overlord100_interfaces::srv::ChangeMode>::SharedPtr
        mode_service_;
